...
import com.example.kyrgyzpedigree.util.GoogleMapCustomInfoWindowAdapter;
import com.example.kyrgyzpedigree.util.PersonStaticFields;
import com.example.kyrgyzpedigree.util.PlaceAutocompleteAdapter;
...
public class MapActivity extends AppCompatActivity implements OnMapReadyCallback,
        ...
        add_button.setOnClickListener(v -> {
            ...
            if (location.equals("") || location.length() < 2) {
                Toast toast3 = Toast.makeText(getApplicationContext(),
                        "wrong place", Toast.LENGTH_SHORT);
                toast3.show();
                return;
            }
            PersonStaticFields.mestojitelstva = location;
    ...
    private void moveCamera(LatLng latLng, float zoom, PlaceInfo placeInfo) {
        ...
        mMap.setInfoWindowAdapter(new GoogleMapCustomInfoWindowAdapter(MapActivity.this));
