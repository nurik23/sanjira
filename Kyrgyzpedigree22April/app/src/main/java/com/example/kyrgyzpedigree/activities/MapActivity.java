...
import com.example.kyrgyzpedigree.util.map.GetNearbyPlaces;
...
public class MapActivity extends FragmentActivity implements
    ...
    public void onClick(View v) {
        ...
        GoogleMap.OnMarkerClickListener onMarkerClickListener = (marker -> {
            ...
            addressField.setText(split[split.length - 1]);
            return true;
        });

        GetNearbyPlaces getNearbyPlaces = new GetNearbyPlaces(onMarkerClickListener);
        switch (v.getId()) {
            ...
            case R.id.schools_nearby:
                mMap.clear();
                String url = getUrl(latitide, longitude, district);
                transferData[0] = mMap;
                transferData[1] = url;

                getNearbyPlaces.execute(transferData);
                Toast.makeText(this, "Searching for Nearby district...", Toast.LENGTH_SHORT).show();
                Toast.makeText(this, "Showing Nearby district...", Toast.LENGTH_SHORT).show();
                break;
        }
    }
    ...
    private String getUrl(double latitide, double longitude, String nearbyPlace) {
        ...
        googleURL.append("&key=" + "AIzaSyDfNNikSiJUXU3ZZYZUFPQbpU1oEhPEMU4");
