...
public class PodrodRestController {
    ...
    @GetMapping("/byRodName/{rodName}")
    public List<Podrod> getPodrodListByRodName(@PathVariable String rodName) {
        return podrodRepository.findPodrodsByRodNameLike(rodName);
    }
}
